...
var gBVType='firefox',gBVVersion='20',gOSType='linux';
...
gSN=new Array('<b>','<h1>','<h2>','<h3>','<h4>','<h5>','<h6>','<h7>','<strong>','<em>','<i>');
...
t_s='20071220042716';
mk=1;
server='fortunecity.us.intellitxt.com';
cc='us';
rcc='us';
itxtreg='al';
itxtdma='630';
...
gFTTm= new parr('');gFTTm.set(32,'preloader.swf$$320$$200$$8');gFTTm.set(34,'preloader.swf$$320$$200$$8');gFTTm.set(17,'preloader.swf$$320$$200$$8');gFTTm.set(53,'preloader.swf$$320$$250$$8');gFTTm.set(58,'preloader.swf$$320$$230$$8');gFTTm.set(60,'preloader.swf$$320$$230$$8');gFTTm.set(48,'preloader.swf$$300$$250$$8');gFTTm.set(46,'preloader.swf$$320$$200$$8');gFTTm.set(52,'preloader.swf$$320$$250$$8');gFTTm.set(54,'preloader.swf$$320$$250$$8');
...
gFdBck='';
gSI=1;
gSID='59433c77fe96221c1f94c8ba04015b1f';
gMiFo=0;
mTL=50;
gDrag=1;
gMSNsb=-1;
...
gHLN=1;
gKWPF=0;
gPVU='de7218687426446f9ffc70d84e74fcac';
gPVM='4120c6143284307b1c0e3ab556c08867';
gMImgW=180;
gMImgH=200;
iTTC=0;
gCSc='';
...
if((dtc)||((true && ((bCF==1 && gCL) || (gIRB==1 && bCF==0 && gCL>=(gLCL * 1.1)) || (gDTo==false && gIRB==1 && bCF==0 && Math.abs(gCL-gLCL)>=(gLCL * 10) / 100))))) {
gINt=' zxz ';
...
iNBc=0,
iADi=0,
sRU='http://ebrox.fortunecity.com/',
gMR=1000,
bWAC=0,
bYCR=0,
gMNC=255,
...
itxtInited=1;
itxtLES('http://images.intellitxt.com/ast/js/vm/func_200712041748.js');
}
startIntelliTXT();
